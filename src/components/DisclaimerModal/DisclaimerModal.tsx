    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Scorpion protocol have made
      ...
      return (
        <div>
          <p>Attention SCORP Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with SCORP is SCORP/yCRV
            (Curve yPool tokens)
          </p>
