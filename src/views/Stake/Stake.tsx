...
const Farm: React.FC = () => {
  ...
  // const { onRedeem } = useRedeem(getEmperorScorpionContract(scorpion))
      ...
      {!!account ? (
        <>
          <PageHeader
            ...
            title="Stake Scorpion Tokens & Earn Fees"
            subtitle="0.05% of all ScorpionSwap trades are rewarded to SCORP stakers"
          />
          {/* <FarmCards /> */}
          <div>TBD</div>
        </>
